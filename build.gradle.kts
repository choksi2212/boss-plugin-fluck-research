...
tasks.register<Jar>("buildPluginJar") {
    archiveFileName.set("boss-plugin-fluck-research-${version}.jar")
    duplicatesStrategy = DuplicatesStrategy.EXCLUDE
    manifest {
        attributes(
            "Implementation-Title" to "BOSS Fluck Research Plugin",
            "Implementation-Version" to version,
            "Main-Class" to "ai.rever.boss.plugin.dynamic.fluckresearch.FluckResearchDynamicPlugin",
        )
    }
